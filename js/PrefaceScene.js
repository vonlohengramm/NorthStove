...
preface.preload = function () {
    this.load.image('back', 'png/preface-back.jpg');
    this.load.image('logo', 'png/logo.png');
    this.load.image('prompt-back', 'png/preface-prompt-back.png');
    this.load.image('title', 'png/preface-title.png');
}
preface.create =  function () {
    this.add.image(SCENE_WIDTH / 2 * GENERAL_SCALE, SCENE_HEIGHT / 2 * GENERAL_SCALE, 'back').setScale(GENERAL_SCALE);
    ...
    var title = this.add.image(3445 * GENERAL_SCALE, 3097 * GENERAL_SCALE, 'title').setScale(GENERAL_SCALE);
